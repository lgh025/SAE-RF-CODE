...
cnst.allClassifiers = { 'linSVM'}; %{'1NN', 'ensembleTree', 'linSVM', 'rbfSVM'}; 
...
[CatNames, source_and_target, myData, myLabels] = ...
    load_feature_dataset_sda(currFSet, cnst.FeatureDataSource);
...
zuhe=[acc10 meanAUC10 stdAUC10];
save zuhe_linsvm_sda zuhe
% save meanAUC10_per meanAUC10
% save stdAUC10_per stdAUC10
% save acc10_lbp_dan acc10
1-mean(meanAUC10,1)
 1-mean(stdAUC10,1)
 1-mean(acc10,1)
