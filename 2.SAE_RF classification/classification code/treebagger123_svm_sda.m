...
Xdata= [data1(:,1:36)  data1(:,75:110) data1(:,112:115) data1(:,142:951) data1(:,952:end)];
...
%   train_data_sda=data1(:,142:951);
%  idx_sda = sda2(train_data_sda,target,logname)   
%   Xdata= [data1(:,1:36)  data1(:,75:110) data1(:,112:115) train_data_sda(:,idx_sda) data1(:,952:end)];
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  label_all=db_label10{1};
 aa=0;
...
%     acc3_svm = mean(label_all(number) == result2_svm)
...
zuhe=[acc3 meanAUC stdAUC];
save zuhe_SDA_RF zuhe
