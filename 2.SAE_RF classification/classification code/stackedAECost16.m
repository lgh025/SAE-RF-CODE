function [ cost, grad ] = stackedAECost16(theta, inputSize, hiddenSize, ...
...
%
z2 = bsxfun(@plus, stack{1}.w*data', repmat(stack{1}.b, 1, M));
a2 = sigmoid(z2);
z3 = bsxfun(@plus, stack{2}.w*a2, repmat(stack{2}.b, 1, size(a2, 2)));
a3 = sigmoid(z3);
